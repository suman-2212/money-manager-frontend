        ...
        <div className="modal-overlay" onClick={onClose}>
            <div className="modal-content max-w-lg w-full" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-200">
                    <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Edit Transaction</h2>
                    <button
                        onClick={onClose}
                ...
                {showDeleteConfirm ? (
                    <div className="space-y-4">
                        <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
                            <h3 className="font-semibold text-red-900 mb-2">Delete Transaction?</h3>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-gray-200">
                            <button
                                ...
                                className="btn-danger inline-flex items-center justify-center gap-2 order-3 sm:order-1"
                                disabled={loading}
                            >
                                <FaTrash />
                                Delete
